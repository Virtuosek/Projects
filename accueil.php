...
<div id="image_accueil">
    <section>
        <h2>Achats des produits de décorations</h2>
        <p>Achat de 1 276pièces au prix moyen de 17.35 euros</p>
        <p>Vente de 834 pièces au prix moyen de 38,13 euros</p>
    </section>
    
    <section>
        <h2>Achats des produits d'ameublement</h2>
